...
if (isset($_GET['txtID'])) {
    ...
    //instruccion sql
    $sentencia = $conexion->prepare("DELETE FROM tbl_software WHERE id=:id");
...
$sentencia = $conexion->prepare("SELECT *,(SELECT nombretitulada FROM tbl_tituladas WHERE tbl_tituladas.id=tbl_software.idtitulada limit 1) as titulada 
FROM `tbl_software`");
$sentencia->execute();
$lista_tbl_software = $sentencia->fetchALL(PDO::FETCH_ASSOC);
...
<div>
    ...
    <div class="instructor">
        ...
        <div class="card" style="width: 11rem;">
            ...
            <div class="card-body">
                <a name="" id="" class="btn btn-outline-info" href="./instructor1/index.php" role="button">Ver Instructor(a)</a>
            </div>
        </div>
...
<br />
<h3>Aprendices De Desarrollo Software</h3>
        ...
        <div class="table-responsive-sm">
            <table class="table" id="tabla_id">
                ...
                <tbody>
                    ...
                    <?php foreach ($lista_tbl_software as $registro) { ?>
                        ...
                        <tr class="">
                            ...
                            <td>
                                <?php echo $registro['cc'] ?>
                            </td>
                            <td>
                                <?php echo $registro['titulada'] ?>
                            </td>
                            <td>

...
if(isset( $_GET['txtID'] )){
    ...
    //instruccion sql
    $sentencia=$conexion->prepare("DELETE FROM tbl_instructor2 WHERE id=:id");
...
$sentencia=$conexion->prepare("SELECT *,(SELECT nombretitulada FROM tbl_tituladas WHERE tbl_tituladas.id=tbl_instructor2.idtitulada limit 1) as titulada 
FROM `tbl_instructor2`");
$sentencia->execute();
$lista_tbl_instructor2=$sentencia->fetchALL(PDO::FETCH_ASSOC);
...
<div>
    <div>
        <a href="/app-sena/secciones/cocina/"><button class="btn btn-outline-success"
        ...
        <div class="table-responsive-sm">
            <table class="table" id="tabla_id">
                ...
                <tbody>
                    ...
                    <?php foreach ($lista_tbl_instructor2 as $registro) { ?>

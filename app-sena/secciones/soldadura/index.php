...
if(isset( $_GET['txtID'] )){
    ...
    //instruccion sql
    $sentencia=$conexion->prepare("DELETE FROM tbl_soldadura WHERE id=:id");
...
$sentencia=$conexion->prepare("SELECT *,(SELECT nombretitulada FROM tbl_tituladas WHERE tbl_tituladas.id=tbl_soldadura.idtitulada limit 1) as titulada 
FROM `tbl_soldadura`");
$sentencia->execute();
$lista_tbl_soldadura=$sentencia->fetchALL(PDO::FETCH_ASSOC);
...
<div>
    ...
    <div class="instructor">
        ...
        <div class="card" style="width: 11rem;">
            ...
            <div class="card-body">
                <a name="" id="" class="btn btn-outline-info" href="./instructor6/index.php" role="button">Ver Instructor(a)</a>
            </div>
        </div>
        ...
        <div class="table-responsive-sm">
            <table class="table" id="tabla_id">
                ...
                <tbody>
                    ...
                    <?php foreach ($lista_tbl_soldadura as $registro) { ?>

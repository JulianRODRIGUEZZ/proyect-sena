...
$sentencia=$conexion->prepare("SELECT *,(SELECT nombretitulada FROM tbl_tituladas WHERE tbl_tituladas.id=tbl_entre.idtitulada limit 1) as titulada 
FROM `tbl_entre`");
$sentencia->execute();
$lista_tbl_entre=$sentencia->fetchALL(PDO::FETCH_ASSOC);
...
<div>
    ...
    <div class="instructor">
        ...
        <div class="card" style="width: 11rem;">
            ...
            <div class="card-body">
                <a name="" id="" class="btn btn-outline-info" href="./instructor3/index.php" role="button">Ver Instructor(a)</a>
            </div>
        </div>
...
<br />
<h3>Aprendices De Entrenamiento Deportivo</h3>
<div class="card">
        ...
        <div class="table-responsive-sm">
            <table class="table" id="tabla_id">
                ...
                <tbody>
                    ...
                    <?php foreach ($lista_tbl_entre as $registro) { ?>

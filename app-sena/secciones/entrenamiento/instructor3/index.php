...
if(isset( $_GET['txtID'] )){
    ...
    //instruccion sql
    $sentencia=$conexion->prepare("DELETE FROM tbl_instructor3 WHERE id=:id");
...
$sentencia=$conexion->prepare("SELECT *,(SELECT nombretitulada FROM tbl_tituladas WHERE tbl_tituladas.id=tbl_instructor3.idtitulada limit 1) as titulada 
FROM `tbl_instructor3`");
$sentencia->execute();
$lista_tbl_instructor3=$sentencia->fetchALL(PDO::FETCH_ASSOC);
...
<div>
    <div>
        <a href="/app-sena/secciones/entrenamiento/"><button class="btn btn-outline-success"
        ...
        <div class="table-responsive-sm">
            <table class="table" id="tabla_id">
                ...
                <tbody>
                    ...
                    <?php foreach ($lista_tbl_instructor3 as $registro) { ?>
